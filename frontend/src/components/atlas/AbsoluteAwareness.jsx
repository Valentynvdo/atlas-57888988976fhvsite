    ...
    >
      ...
      >
        ...
        <div className="reveal delay-1" style={{ order: 1 }}>
          <div className="section-eyebrow">Абсолютна Свідомість</div>
          <h2
          ...
          >
            <span className="gradient-text">Пам'ятає те,</span>
            <br />
            <span
              style={{
                background:
                  "linear-gradient(120deg, #9D4CDD, #00E5FF)",
          ...
          >
            Атлас впізнає вас в обличчя, пам'ятає ваші адреси, вподобання та
            імена ваших гостей, забезпечуючи абсолютно персоналізований
            досвід — без зайвих запитань.
          </p>
