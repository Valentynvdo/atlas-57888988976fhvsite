...
export default function Docs() {
  ...
  return <div style={{
    ...
    fontFamily: "Inter, system-ui, sans-serif"
      ...
      right: 0,
      height: "100vh",
      background: "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(255,255,255,0.040), transparent 70%), radial-gradient(ellipse 50% 50% at 80% 80%, rgba(255,255,255,0.020), transparent 60%)",
      pointerEvents: "none",
      zIndex: 0
    }} />
      ...
      zIndex: 1
        ...
        placeItems: "center",
        marginBottom: 20,
        boxShadow: "0 0 30px rgba(255,255,255,0.120)"
      }}>
        ...
        flexShrink: 0,
          ...
          gap: 6
            ...
            return <button key={sec.id} onClick={() => scrollTo(sec.id)} style={{
              ...
              borderRadius: 10,
              border: "none",
              background: active ? "rgba(255,255,255,0.048)" : "transparent",
...
main();`} />
              ...
              textAlign: "center"
                ...
                boxShadow: "0 0 20px rgba(255,255,255,0.120)",
                display: "grid",
                placeItems: "center",
                color: "#2997ff",
                marginBottom: 16
          ...
          marginBottom: 80
            ...
            overflowX: "auto"
              ...
              padding: "0 20px"
                ...
                flex: 0.5,
                height: 1,
                background: "linear-gradient(90deg, #2997ff, #28C840)",
                position: "relative"
              }}>
                  <div style={{
                  position: "absolute",
              ...
              marginTop: 8
                ...
                width: 1,
                height: 32,
                background: "linear-gradient(180deg, #2997ff, rgba(255,255,255,0.000))"
              }} />
              </div>
              <div style={{
              display: "flex",
                  ...
                  <CodeBlock lang="json" code={`// Response (Success 200)
{
  ...
  "current_thought": "Аналізую сторінки репозиторію Vosk для оптимізації голосових потоків..."
          ...
          marginBottom: 80
            ...
            <div style={{ padding: 24, borderRadius: 16, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
              ...
              <div style={{ marginTop: 16 }}>
                <a href={isEn ? "/en/login" : "/login"} style={{ color: "#2997ff", textDecoration: "none", fontWeight: 500 }}>
          ...
          marginBottom: 80
            ...
            <div style={{ padding: 24, borderRadius: 16, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.075)" }}>
              ...
              <div style={{ marginTop: 24 }}>
                <a href="https://t.me/AtlasAICommunity" target="_blank" rel="noreferrer" style={{ display: "inline-flex", padding: "10px 20px", background: "#2997ff", color: "#000", fontWeight: 600, borderRadius: 8, textDecoration: "none" }}>
          ...
          padding: "48px 32px",
          borderRadius: 24,
          background: "linear-gradient(135deg, rgba(255,255,255,0.030), rgba(255,255,255,0.012))",
...
function formatMarkdown(text) {
  ...
  html = html.replace(/\[([^\]]+)\]\(([^)]+)\)/g, (match, text, url) => {
    return `<a href="${sanitizeUrl(url)}" target="_blank" rel="noreferrer" style="color: #2997ff; text-decoration: underline;">${text}</a>`;
  });
  return html;
}