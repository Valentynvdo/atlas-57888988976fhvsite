  ...
  return (
    ...
    >
      ...
      <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, pointerEvents: "none", zIndex: 0 }}>
        <div style={{ position: "absolute", top: "10%", left: "50%", transform: "translateX(-50%)", width: "80vw", height: "80vh", background: "radial-gradient(ellipse at center, rgba(255,255,255,0.025) 0%, transparent 60%)", filter: "blur(60px)" }} />
        <div style={{ position: "absolute", bottom: "-10%", left: "-10%", width: "50vw", height: "50vh", background: "radial-gradient(circle, rgba(255,255,255,0.030) 0%, transparent 70%)", filter: "blur(60px)" }} />
      </div>
      ...
      <main style={{ padding: "100px 3vw 120px", maxWidth: "100%", margin: "0 auto", position: "relative", zIndex: 1, overflowX: "hidden" }}>
        ...
        <div className="hero-reveal" style={{ textAlign: "center", maxWidth: 1000, margin: "0 auto 80px" }}>
          <div style={{ display: "inline-flex", gap: 16, marginBottom: 32, flexWrap: "wrap", justifyContent: "center" }}>
            <span style={{ color: "#2997ff", fontSize: 13, fontWeight: 600, letterSpacing: "0.05em", display: "flex", alignItems: "center", gap: 6 }}><ServerOff size={14} />{t("investors_page.hero_tag_1")}</span>
        ...
        <div className="investor-reveal" style={{ textAlign: "center", maxWidth: 1000, margin: "0 auto 120px" }}>
          ...
          <a href="mailto:ceo@atlas-assistant.online" style={{ display: "inline-block", marginTop: 40, padding: "16px 36px", fontSize: 18, fontWeight: 600, background: "linear-gradient(135deg, #2997ff 0%, #f5f5f7 100%)", color: "#fff", borderRadius: 12, cursor: "pointer", textDecoration: "none", transition: "opacity 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.opacity = "0.9"} onMouseLeave={(e) => e.currentTarget.style.opacity = "1"}>
        ...
        <div className="investor-reveal" style={{ marginBottom: 120 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 64 }}>
            <div style={{ padding: "0 24px" }}>
              <Terminal size={40} color="#f5f5f7" style={{ marginBottom: 32 }} />
            ...
            <div style={{ padding: "0 24px" }}>
              <EyeOff size={40} color="#f5f5f7" style={{ marginBottom: 32 }} />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 80 }}>
            ...
            <div style={{ padding: "0 24px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 48 }}>
                ...
                <div>
                  <div style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)", fontWeight: 700, color: "#2997ff", marginBottom: 12, letterSpacing: "-0.03em", textShadow: "0 0 40px rgba(255,255,255,0.180)" }}>{t("investors_page.market_sam")}</div>
                  <div style={{ color: "rgba(255,255,255,0.6)", fontSize: 18 }}>{t("investors_page.market_sam_desc")}</div>
                </div>
                <div>
                  <div style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)", fontWeight: 700, color: "#f5f5f7", marginBottom: 12, letterSpacing: "-0.03em", textShadow: "0 0 40px rgba(255,255,255,0.150)" }}>{t("investors_page.market_som")}</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 64, padding: "0 24px" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 48, fontWeight: 700, color: "#2997ff", lineHeight: 1 }}>{t("investors_page.traction_revenue")}</div>
              ...
              {/* Unit Economics */}
              <div>
                <LineChart size={36} color="#2997ff" style={{ marginBottom: 32 }} />
                <h3 style={{ fontSize: 26, fontWeight: 600, marginBottom: 32 }}>{t("investors_page.economics_title")}</h3>
                <div style={{ display: "flex", gap: 24, marginBottom: 32, flexWrap: "wrap" }}>
                  <div style={{ color: "#2997ff", fontWeight: 600, fontSize: 24 }}>{t("investors_page.economics_ltv")}</div>
        ...
        <div className="investor-reveal" style={{ marginBottom: 120, padding: "0 24px" }}>
          ...
          <div style={{ display: "flex", gap: 48, alignItems: "center", flexWrap: "wrap" }}>
            <div style={{ width: 140, height: 140, borderRadius: "50%", background: "linear-gradient(135deg, #f5f5f7, #f5f5f7)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 48, fontWeight: 700 }}>VV</div>
            <div style={{ flex: 1, minWidth: 300 }}>
              <h4 style={{ fontSize: 32, fontWeight: 600, margin: "0 0 12px 0" }}>{t("investors_page.team_name")}</h4>
              <div style={{ color: "#2997ff", fontWeight: 500, marginBottom: 24, fontSize: 18 }}>{t("investors_page.team_role")}</div>
        ...
        <div className="investor-reveal">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: 32 }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 32, padding: "48px", position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", top: -100, right: -100, width: 300, height: 300, background: "radial-gradient(circle, rgba(255,255,255,0.090) 0%, transparent 70%)", filter: "blur(40px)" }} />
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 32 }}>
                ...
                <Target size={48} color="#2997ff" opacity={0.5} />
              </div>
              ...
              <div style={{ background: "rgba(0,0,0,0.3)", borderRadius: 16, padding: "24px", border: "1px solid rgba(255,255,255,0.05)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 16 }}>
                  ...
                  <span style={{ color: "#2997ff", fontSize: 15, fontWeight: 600 }}>{t("investors_page.progress_status")}</span>
                </div>
                <div style={{ height: 8, background: "rgba(255,255,255,0.1)", borderRadius: 4, overflow: "hidden", marginBottom: 12 }}>
                  <div className="progress-fill" style={{ width: "0%", height: "100%", background: "linear-gradient(90deg, #f5f5f7, #2997ff)", borderRadius: 4 }} />
                </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
              ...
              <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 32, padding: "40px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {[
                    { label: t("investors_page.alloc_dev"), color: "#2997ff" },
                    { label: t("investors_page.alloc_mkt"), color: "#f5f5f7" },
                    { label: t("investors_page.alloc_infra"), color: "#f5f5f7" },
                  ].map((item, i) => (
        ...
        >
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, background: "radial-gradient(ellipse at center, rgba(255,255,255,0.030) 0%, transparent 60%)" }} />
