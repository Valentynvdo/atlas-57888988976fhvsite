  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ color: "rgba(255,255,255,0.65)", lineHeight: 1.7, fontSize: 14, marginBottom: 16 }}>
          Ви маєте повне право в будь-який момент запросити видалення вашого акаунту та всіх пов'язаних з ним ліцензійних ключів з нашої бази даних. Для цього зверніться до служби підтримки в Telegram або надішліть запит на пошту, вказану в контактах.
        </p>
      </div>
    </div>
  );
