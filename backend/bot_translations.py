...
TEXTS = {
    "uk": {
        ...
        "faq_install": (
            ...
            "A: Завантажте DMG файл у вашому особистому кабінеті на сайті.\nВідкрийте файл, перетягніть Atlas в папку 'Програми' та введіть Ваш ліцензійний ключ для активації. 🚀\n\n"
        ...
        "faq_general": (
            ...
            "A: У Вашому кабінеті (Dashboard) в секції «Налаштування Telegram Бота» Ви можете вказати токен Вашого власного бота. Це забезпечить 100% приватність і дозволить керувати Atlas AI прямо зі смартфона. 🕹️\n\n"
    ...
    "en": {
        ...
        "faq_install": (
            ...
            "A: Download the DMG file from your personal dashboard on the website.\nOpen the file, drag Atlas to the Applications folder, and enter your license key to activate. 🚀\n\n"
        ...
        "faq_general": (
            ...
            "A: In your Dashboard under the «Telegram Bot Configuration» section, you can enter your own bot's token. This ensures 100% privacy and allows you to send commands to your Atlas AI directly from your smartphone. 🕹️\n\n"
